...
public class Capes {
    private static final String CAPE_OWNERS_URL = "http://polluxclient.com:8082/api/capeowners";
    private static final String CAPES_URL = "http://polluxclient.com:8082/api/capes";
    ...
    public static void init() {
        // Cape owners
        PolluxExecutor.execute(() -> HttpUtils.getLines(CAPE_OWNERS_URL, s -> {
        ...
        // Capes
        PolluxExecutor.execute(() -> HttpUtils.getLines(CAPES_URL, s -> {
            String[] split = s.split(" ");
    ...
    private static class Cape extends Identifier {
        ...
        public Cape(String name) {
            super("pollux-client", "capes/" + name);

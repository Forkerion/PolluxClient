...
package rardoger.polluxclient.utils;
...
public class Utils {
    ...
    public static void addPolluxPvpToServerList() {
        ...
        for (int i = 0; i < servers.size(); i++) {
            ...
            if (server.address.contains("minetime.com")) {
                contains = true;
                break;
            }
        }
        ...
        if (!contains) {
            servers.add(new ServerInfo("Anarchy", "minetime.com", false));
            servers.saveFile();
        }
    }

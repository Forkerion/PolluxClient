...
import rardoger.polluxclient.events.world.BlockActivateEvent;
...
public class EChestMemory {
    ...
    public static void init() {
        PolluxClient.EVENT_BUS.subscribe(onBlockActivate);
        PolluxClient.EVENT_BUS.subscribe(onOpenScreenEvent);
    }

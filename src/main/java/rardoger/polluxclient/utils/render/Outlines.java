...
package rardoger.polluxclient.utils.render;

import rardoger.polluxclient.mixin.WorldRendererAccessor;
...
public class Outlines {
    ...
    public static void load() {
        try {
            ...
            outlinesShader = new ShaderEffect(mc.getTextureManager(), mc.getResourceManager(), mc.getFramebuffer(), new Identifier("pollux-client", "shaders/post/my_entity_outline.json"));

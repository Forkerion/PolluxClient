...
public class MFont {
    ...
    private static final rardoger.polluxclient.utils.render.color.Color SHADOW_COLOR = new rardoger.polluxclient.utils.render.color.Color(60, 60, 60, 180);
    ...
    public double renderString(String string, double x, double y, rardoger.polluxclient.utils.render.color.Color color) {
    ...
    public double renderStringWithShadow(String string, double x, double y, rardoger.polluxclient.utils.render.color.Color color) {
        boolean wasBuilding = isBuilding();
        if (!isBuilding()) begin();
    ...
    public class CharData {
        ...
        public void render(MeshBuilder mb, double x, double y, rardoger.polluxclient.utils.render.color.Color color) {

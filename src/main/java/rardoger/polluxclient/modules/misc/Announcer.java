...
import rardoger.polluxclient.events.entity.DropItemsEvent;
import rardoger.polluxclient.events.entity.player.BreakBlockEvent;
import rardoger.polluxclient.events.entity.player.PickItemsEvent;
import rardoger.polluxclient.events.entity.player.PlaceBlockEvent;
...
public class Announcer extends ToggleModule {
    ...
    public void onActivate() {
        for (Feature feature : features) {
            if (feature.isEnabled()) {
                PolluxClient.EVENT_BUS.subscribe(feature);
                feature.reset();
            }
        }
    }
    ...
    public void onDeactivate() {
        for (Feature feature : features) {
            if (feature.isEnabled()) {
                PolluxClient.EVENT_BUS.unsubscribe(feature);
            }
        }
    }

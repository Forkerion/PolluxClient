...
import rardoger.polluxclient.events.world.ChunkDataEvent;
import rardoger.polluxclient.gui.screens.StashFinderChunkScreen;
...
public class StashFinder extends ToggleModule {
    ...
    public StashFinder() {
        super(Category.Misc, "stash-finder", "Searches loaded chunks for storage blocks. Saves to <your minecraft folder>/pollux-client");
    }
    ...
    private File getJsonFile() {
        return new File(new File(new File(PolluxClient.FOLDER, "stashes"), Utils.getWorldName()), "stashes.json");
    }

    private File getCsvFile() {
        return new File(new File(new File(PolluxClient.FOLDER, "stashes"), Utils.getWorldName()), "stashes.csv");
    }

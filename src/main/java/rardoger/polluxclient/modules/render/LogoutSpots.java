...
import rardoger.polluxclient.rendering.*;
...
public class LogoutSpots extends ToggleModule {
    ...
    private class Entry {
        ...
        public void render(RenderEvent event) {
            ...
            // Render background
            double i = PolluxClient.FONT_2X.getStringWidth(name) / 2.0 + PolluxClient.FONT_2X.getStringWidth(healthText) / 2.0;
            ...
            double hX = PolluxClient.FONT_2X.renderString(name, -i, 0, nameColor.get());
            PolluxClient.FONT_2X.renderString(healthText, hX, 0, healthColor);

...
import rardoger.polluxclient.modules.player.ChestSwap;
...
public class ElytraPlus extends ToggleModule {
    ...
    protected void enableGroundListener() {
        PolluxClient.EVENT_BUS.subscribe(chestSwapGroundListener);
    }

    protected void disableGroundListener() {
        PolluxClient.EVENT_BUS.unsubscribe(chestSwapGroundListener);
    }

...
package rardoger.polluxclient.waypoints;
...
public class Waypoints extends Savable<Waypoints> implements Listenable, Iterable<Waypoint> {
    ...
    public void add(Waypoint waypoint) {
        ...
        PolluxClient.EVENT_BUS.post(EventStore.waypointListChangedEvent());
        save();
    }
    ...
    @Override
    public File getFile() {
        return new File(new File(PolluxClient.FOLDER, "waypoints"), Utils.getWorldName() + ".nbt");
    }
    ...
    public static void loadIcons() {
        File iconsFolder = new File(new File(PolluxClient.FOLDER, "waypoints"), "icons");
        iconsFolder.mkdirs();
    ...
    private static void copyIcon(File file) {
        try {
            InputStream in = Waypoints.class.getResourceAsStream("/assets/pollux-client/waypoint-icons/" + file.getName());

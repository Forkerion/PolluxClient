...
public class Ignore extends Command {
    ...
    public static void load() {
        File file = new File(PolluxClient.FOLDER, "ignored_players.txt");
        if (file.exists()) {
            try {
    ...
    public static void save() {
        try {
            BufferedWriter writer = new BufferedWriter(new FileWriter(new File(PolluxClient.FOLDER, "ignored_players.txt")));

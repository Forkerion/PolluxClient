...
import static rardoger.polluxclient.utils.Utils.mc;
...
public class Friend extends Command {
    ...
    public void build(LiteralArgumentBuilder<CommandSource> builder) {
        builder.then(literal("add")
                .then(argument("friend", FriendArgumentType.friend())
                        .executes(context -> {
                            rardoger.polluxclient.friends.Friend friend =
                                    context.getArgument("friend", rardoger.polluxclient.friends.Friend.class);
                ...
                .then(literal("list").executes(context -> {
                    ...
                    for (rardoger.polluxclient.friends.Friend friend : FriendManager.INSTANCE) {
    ...
    private static class FriendArgumentType implements ArgumentType<rardoger.polluxclient.friends.Friend> {
        ...
        @Override
        public rardoger.polluxclient.friends.Friend parse(StringReader reader) throws CommandSyntaxException {
            return new rardoger.polluxclient.friends.Friend(reader.readString());
        }
